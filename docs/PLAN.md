...
**Domain:** chessco.org • **Slogan:** _Scout. Prepare. Win._ • **Spec:** chessco-full-spec.md v1.0 (2026-05-11)
...
| Marketplace pricing (user spec) | $0.50 bullet / $1 blitz / $2 rapid / $5 classical (default ladders) | These are _default_ fee suggestions in `/challenges/new`; creator can override within bounds.                                                                                           |
...
| Week | Deliverables                                                                                                                                                                                                                                                                                    |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | **Stockfish workers on Cloud Run** (autoscaling, depth 18 default, 25 for critical positions). Batch analysis pipeline — given a game*id, populate `moves.eval*\*`and`cp_loss`, mark blunders/mistakes/inaccuracies.                                                                            |
