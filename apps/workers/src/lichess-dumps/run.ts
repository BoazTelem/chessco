 ...
 *
 * The historical --scan-handles-only mode was removed on 2026-05-18: it
 * existed to seed lichess_crawl_queue for the per-handle API crawler,
 * which was deprecated after Lichess confirmed bulk per-handle
 * enumeration is forbidden. See
