/**
 * Wire protocol between the web client (GamePlayer.tsx) and the realtime
 * game-room server. JSON-encoded over a single WebSocket connection per
 * (match, user) pair.
 *
 * Keep this file consumable from the web side too — copy it verbatim to
 * apps/web/lib/practice/protocol.ts when implementing the client.
 */
